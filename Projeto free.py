...
janela_principal = [
     ...
     [sg.FolderBrowse('Escolher Pasta De Anexos',target='input_anexos'),sg.Input
     (key='input_anexos')],
     [sg.FolderBrowse('Escolher Pasta De Planilhas',target='input_planilha'),sg.Input
     (key='input_planilha')],
     [sg.Button('Salvar')]
]
...
while True:
    ...
    if event == sg.WIN_CLOSED:
        ...
        print(f'O caminho da paste de planilhas é: {caminho_pasta_planilha}')